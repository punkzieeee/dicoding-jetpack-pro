...
class TVShowFavoriteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemTouchHelper.attachToRecyclerView(fragmentTVShowFavoriteBinding?.rvFavTvshow)
        ...
        if (activity != null) {
            ...
            fragmentTVShowFavoriteBinding?.rvFavTvshow?.layoutManager = LinearLayoutManager(context)
            fragmentTVShowFavoriteBinding?.rvFavTvshow?.setHasFixedSize(true)
            fragmentTVShowFavoriteBinding?.rvFavTvshow?.adapter = favTVShowAdapter
        }
    }
