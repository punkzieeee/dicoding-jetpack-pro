...
class MovieFavoriteFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemTouchHelper.attachToRecyclerView(fragmentMovieFavoriteBinding?.rvMovie)
        ...
        if (activity != null) {
            ...
            fragmentMovieFavoriteBinding?.rvMovie?.layoutManager = LinearLayoutManager(context)
            fragmentMovieFavoriteBinding?.rvMovie?.setHasFixedSize(true)
            fragmentMovieFavoriteBinding?.rvMovie?.adapter = favMovieAdapter
        }
    }
